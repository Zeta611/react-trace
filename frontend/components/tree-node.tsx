    ...
    return (
      ...
      >
        ...
        <div className="relative flex gap-1.5 h-6 items-center">
          <span className="font-mono font-black text-card-foreground text-center leading-none text-sm">
            {data.label}
          </span>
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-3 py-1.5 border-b border-border bg-blue-400 font-black text-card-foreground flex items-center justify-between">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="text-muted-foreground border-b border-border/50">
                  <th className="pr-2 pb-0.5 font-semibold">label</th>
                  <th className="pr-2 pb-0.5 font-semibold">value</th>
                  <th className="pb-0.5 font-semibold">queue</th>
                </tr>
              </thead>
              <tbody>
